      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            {isLogin
              ? "Đăng nhập để xem lại lịch trình đã lưu"
              : "Đăng ký miễn phí để lưu và chia sẻ lịch trình"}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <Label htmlFor="password" className="text-foreground font-medium mb-1.5 block">
                Mật khẩu
              </Label>
              <div className="relative">
            ...
            {isLogin && (
              <div className="text-right">
                <button type="button" className="text-sm text-chip-orange hover:underline">
                  Quên mật khẩu?
                </button>
              </div>
            )}
